"""CLI for multi-LoRA delta-fused serving benchmark."""

import argparse

from ..lora.delta_multi import benchmark_delta_multi
...
def main():
    ...
    for r in results:
        print(f"{r.scenario:15s} {r.latency_s:.3f}s  {r.tokens_per_s:6.1f} tok/s  {r.memory_gb:.2f} GB")
